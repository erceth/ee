   ...
   var jpTerminal = (function() {
      ...
      api.init = function() {
         ...
         if (Modernizr.audio.mp3 || Modernizr.audio.wav || Modernizr.audio.ogg) {
            ...
            beepHTML5.append('<source src="./jurassicsystems/snd/beep.ogg">');
            beepHTML5.append('<source src="./jurassicsystems/snd/beep.mp3">');
            beepHTML5.append('<source src="./jurassicsystems/snd/beep.wav">');

            lockDownHTML5.append('<source src="./jurassicsystems/snd/lockDown.ogg">');
            lockDownHTML5.append('<source src="./jurassicsystems/snd/lockDown.mp3">');
            lockDownHTML5.append('<source src="./jurassicsystems/snd/lockDown.wav">');

            dennisMusicHTML5.append('<source src="./jurassicsystems/snd/dennisMusic.ogg">');
            dennisMusicHTML5.append('<source src="./jurassicsystems/snd/dennisMusic.mp3">');
            dennisMusicHTML5.append('<source src="./jurassicsystems/snd/dennisMusic.wav">');
            ...
            sm.setup({ 
               url: './jurassicsystems/swf/soundManager/',
               onready: function() {
                  env.sounds.beep = sm.createSound({
                     id: 'beep',
                     autoLoad: true,
                     url: './jurassicsystems/snd/beep.mp3'
                  });

                  env.sounds.lockDown = sm.createSound({
                     id: 'lockDown',
                     autoLoad: true,
                     url: './jurassicsystems/snd/lockDown.mp3'
                  });

                  env.sounds.dennisMusic = sm.createSound({
                     id: 'dennisMusic',
                     autoLoad: true,
                     url: './jurassicsystems/snd/dennisMusic.mp3',
                     onfinish: function() {
                        sm.play('dennisMusic');
                     }
                  });
   ...
   name: 'access', 
      ...
      command: function(env, inputLine) {
         ...
         if (arg === '') {
            ...
            $('#main-input').append($('<img id="asciiNewman" src="./jurassicsystems/img/asciiNewman.jpg" />'));
            ...
            setTimeout(function() {
               ...
               function() {
                  setTimeout(function() {
                     ...
                     $('#mac-hd-window').css('background-image', 'url(./jurassicsystems/img/macHDBlur.jpg)');
   ...
   $(document).ready(function() {
      ...
      $(['theKingBlur.jpg',
         ...
         'zebraGirlWindow.jpg']).each(function() {
            new Image().src = './jurassicsystems/img/' + this;
         });

      $.ajax({
         url : './jurassicsystems/swf/theKing.swf'
      });
